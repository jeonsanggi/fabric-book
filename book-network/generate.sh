...
# configtxgen -profile OtherOrgChannel -outputCreateChannelTx ./config/channel2.tx -channelID $CHANNEL2_NAME
# if [ "$?" -ne 0 ]; then
#   echo "Failed to generate channel configuration transaction..."
#   exit 1
# fi
...
# channel2 anchor
#configtxgen -profile OtherOrgChannel -outputAnchorPeersUpdate ./config/Org2MSPanchors2.tx -channelID $CHANNEL2_NAME -asOrg Org2MSP
#if [ "$?" -ne 0 ]; then
#  echo "Failed to generate anchor peer update for Org2MSP..."
#  exit 1
#fi
